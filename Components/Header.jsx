  ...
  return (
   <>
    ...
    <div className="text-center my-8">
       ...
       <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Lorem ipsum dolor sit amet  adipisicing elit. Esse inventore odit nesciunt fugit. Neque tempora, magnam praesentium molestias laborum sapiente.</p>
